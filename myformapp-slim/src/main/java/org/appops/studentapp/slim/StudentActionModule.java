...
package org.appops.studentapp.slim;
...
@SlimModule(serviceName = StudentService.class)
public class StudentActionModule extends ServiceSlimModule {

  @Override
  public void configureModule() {
    bindServiceApi(Student.class);
  }
}
